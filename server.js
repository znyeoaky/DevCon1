...
//take this variable pass to port then we can do a call back.
//so if we want sth to happen once it connects, do consoleLog(back-ticks) to put template literal.
